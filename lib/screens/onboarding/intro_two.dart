...
import 'package:dojo_app/screens/onboarding/intro_three.dart';
...
class IntroScreenTwo extends StatefulWidget {
  IntroScreenTwo({Key? key,}) : super(key: key);
...
class _IntroScreenTwoState extends State<IntroScreenTwo> {
  onPressAction() {
    ...
    Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeftWithFade, child: IntroScreenThree()));
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        ...
                        child: Stack(
                          children: <Widget>[
                            VideoFullScreen(key: UniqueKey(), videoURL: 'https://firebasestorage.googleapis.com/v0/b/dojo-app-9812e.appspot.com/o/assets_app%2Fvideos%2Flevels%2Fpushups%2FLevel-3-Marvin-SpinBike-3.mp4?alt=media&token=0dc527bb-91a7-4fe5-bd3d-9c48bc2d0688', videoConfiguration: 3),
                            ...
                            Column(
                              children: <Widget>[
                                ...
                                HostCard(
                                    ...
                                    bodyText: 'Judges review videos for accuracy and determine their score through consensus'),
