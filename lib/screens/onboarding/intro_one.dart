...
import 'package:dojo_app/screens/onboarding/intro_two.dart';
...
class _IntroScreenOneState extends State<IntroScreenOne> {
  onPressAction() {
    ...
    Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeftWithFade, child: IntroScreenTwo()));
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        ...
                        child: Stack(
                          children: <Widget>[
                            VideoFullScreen(key: UniqueKey(), videoURL: 'https://firebasestorage.googleapis.com/v0/b/dojo-app-9812e.appspot.com/o/assets_app%2Fvideos%2Flevels%2Fpushups%2FLevel-5-Marvin-BasketballCourt-3.mp4?alt=media&token=7a2767ab-951d-4b5a-9d78-b2bf3d2a2198', videoConfiguration: 3),
                            ...
                            Column(
                              children: <Widget>[
                                ...
                                HostCard(
                                    ...
                                    bodyText: 'Players challenge themselves to test their athletic ability.'),
