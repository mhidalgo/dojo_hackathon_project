...
import 'package:dojo_app/screens/onboarding/intro_four.dart';
...
class IntroScreenThree extends StatefulWidget {
  IntroScreenThree({Key? key,}) : super(key: key);
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        ...
                        child: Stack(
                          children: <Widget>[
                            //VideoFullScreen(key: UniqueKey(), videoURL: 'https://firebasestorage.googleapis.com/v0/b/dojo-app-9812e.appspot.com/o/assets_app%2Fvideos%2Flevels%2Fpushups%2FLevel-2-Vanielson-Rink-4.mp4?alt=media&token=24007371-7e9f-4fc2-b353-2ccde82ab3ca', videoConfiguration: 3),
                            ...
                            Column(
                              children: <Widget>[
                                ...
                                HostCard(
                                    ...
                                    bodyText: 'At the end of the week, the top players become a MASTER and unlock their NFT.'),
